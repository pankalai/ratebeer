class BeerClubsController < ApplicationController
  ...
  def create
    ...
    @membership = @beer_club.memberships.build(user: current_user, confirmed: true)
    puts @membership
  ...
  def destroy
    if !admin_user
      return redirect_to beer_club_url(@beer_club), notice: "Destroy possible only for admin."
    end
